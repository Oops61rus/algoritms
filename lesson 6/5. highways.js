...
// const [N, M] = fileContent.toString().trim().split(' ').map(Number);

function highways(m, n) {
  let costs = new Array(m + 1).fill(1);
  costs[0] = 0;
...
//
//   for (let i = 0; i < m; i++) {
//     s += highways(m - i, n - 1) + highways(m - i - 1, n - 1);
//   }
//   return s;
// }

// const result = highways(N, M);
// fs.writeFileSync('output.txt', result.toString());

console.log(highways(4, 2));
console.log(highways(50, 14), 15046208805434619);