...
// const [students, coords] = fileContent.toString().split('\n');

function schoolBuilding(students, coords) {
  return coords.split(' ')[Math.round((students / 2) - 1)];
}

// const result = schoolBuilding(students, coords);

// fs.writeFileSync('output.txt', result.toString())

console.log(schoolBuilding(4, '1 2 3 4'));
console.log(schoolBuilding(3, '-1 0 1'));
console.log(schoolBuilding(5, '-9 -1 8 9 10'));